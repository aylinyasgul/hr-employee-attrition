...
Identical to 04-deployment/train.py — kept separate so each stage is self-contained.
"""
...
EXPERIMENT_NAME = "employee-attrition-monitoring"
RANDOM_STATE = 42
...
def train_and_log(X_train, y_train, X_test, y_test):
    ...
    with mlflow.start_run(run_name="xgboost-monitoring") as run:
        ...
        mlflow.sklearn.log_model(model, name="model", input_example=X_train.iloc[:1])
...
def main():
    print("\n=== Employee Attrition — Monitoring Training ===\n")
